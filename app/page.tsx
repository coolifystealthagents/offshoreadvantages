    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Orange advantage scorecard</p>
          <h1>Offshore Advantages: an advantage score wall for clearer staffing decisions.</h1>
          <p className="lead">A redesigned offshore advantages guide for leaders comparing the pros, cons, planning, and risks of offshore staffing. The page now uses a distinct bold offset scorecards layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>ranked advantage markers</figcaption></figure>
      </div>
    </section>
