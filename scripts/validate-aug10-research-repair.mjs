...
if(!/datePublished:\s*post\.published/.test(page)||!/dateTime=\{post\.published\}/.test(page)||!/alternates:\s*\{\s*canonical:/.test(page))throw new Error('Rendered contract missing');
